...
//  Versioning.swift
//  GPS Log
//  Adapted from BlockCam, December 2019
//
...
public class Versioning: CustomStringConvertible
{
    ...
    public static let ApplicationName = "GPS Log"
    
    /// Tag for the application.
    public static let Tag: String = "Alpha"
    
    /// ID of the application.
    public static let ProgramID = "cbebadda-c45c-424b-8a22-7e60aa63f32a"
    ...
    /// Build number.
    public static let Build: Int = 155
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "72D453CF-021E-4326-A9D8-1997EC29CACA"
    
    /// Build date.
    public static let BuildDate: String = "12 December 2019"
    
    /// Build Time.
    public static let BuildTime: String = "17:51"
