...
open class MSActivityIndicatorView: UIView {
    ...
    #if true
    func MakeLoaderAnimation(WithDuration: TimeInterval = 0.7) -> CABasicAnimation
{
    let Anim = CABasicAnimation(keyPath: "transform.rotation")
    Anim.fromValue = NSNumber(value: 0.0 as Double)
    Anim.toValue = NSNumber(value: 2 * Double.pi)
    Anim.duration = WithDuration
    ...
    private let loaderRotationAnimation: CABasicAnimation = {
        ...
        loaderRotationAnimation.duration = RotationTime
    ...
    open func startAnimating() {
        ...
        isHidden = false
        #if true
        loaderLayer.add(MakeLoaderAnimation(WithDuration: _RotationDuration), forKey: Constants.rotationAnimationKey)
        #else
    ...
    private var _RotationDuration = 0.7
    open var RotationDuration: TimeInterval
    {
        get
        {
        ...
        set
        {
            ...
            MSActivityIndicatorView.RotationTime = _RotationDuration
        }
    }
    
    private static var RotationTime: TimeInterval = 0.7
